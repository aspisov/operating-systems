...
void gardener_work(int sockfd, struct sockaddr_in* servaddr, socklen_t addr_len, int gardener_id, int start_x, int start_y, int direction) {
    Message msg;
...
int main() {
    ...
    gardener_work(sockfd, &servaddr, addr_len, 1, 0, 0, 1);  // Gardener 1
    gardener_work(sockfd, &servaddr, addr_len, 2, M - 1, N - 1, -1);  // Gardener 2
